...
test('example menu reopens existing projects and hides build directories',async({page})=>{
 await page.locator('.examples-menu>summary').click();await page.locator('#example-tickets').click();await expect(page.locator('.document-tab')).toContainText('tickets.ag');
 await page.locator('.examples-menu>summary').click();await page.locator('#example-tickets').click();
